...
import Header from "../../components/ArtScreenComponent/Header/Header.component";
import Detail from "../../components/ArtScreenComponent/Detail/Detail.component";
...
const ArtScreen = ({ route }: { route: { params: { id: string } } }) => {
  ...
  if (!fontLoaded || fontError || !route.params.id) {
    return <></>;
  }
