...
import { Container, WrapperScroll } from './UserProfile.style'
...
import Header from '../../components/UserProfileComponent/Header/Header.component';
import ProfileDetails from '../../components/UserProfileComponent/ProfileDetails/ProfileDetails.component';
import ArtDetails from '../../components/UserProfileComponent/ArtDetails/ArtDetails.component';
...
const UserProfileScreen = ({
    ...
    return (
		<Container>
			<WrapperScroll>
				<Header />
				<ProfileDetails user={userDetails as IUser} />
