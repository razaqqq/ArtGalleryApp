...
describe('Edit Profile Test', () => {
    it('should render profile details correctly', async () => {
		...
		const usernameInput = getByTestId('usernameInputTestIndex');
		const fullnameInput = getByTestId('fullnameInputTestIndex');
		const emailInput = getByTestId('emailInputTestIndex');
		const bioInput = getByTestId('bioInputTestIndex');
		const twitterInput = getByTestId('twitterInputTestID');
		const instagramInput = getByTestId('instagramInputTestID');
		const websiteInput = getByTestId('websiteInputTestID');
    ...
    it("should display the user's profile image correctly", async () => {
		...
		await waitFor(() => {
			expect(getByTestId('profileImageTestID').props.source.uri).toBe(
    ...
    it('should allow the user to upload the new profile image', async () => {
		...
		fireEvent.press(getByTestId('uploadImageButtonTestID'));
    ...
    it('should handle the case when user provides an invalid username', async () => {
		...
		const saveButton = getByTestId('saveButtonTestIndex');
